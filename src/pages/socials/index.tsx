  ...
  return (
    <Layout>
      ...
      <div className="grid grid-cols-4 gap-5  mb-10">
        ...
        <div className="flex justify-center items-center  h-[350] bg-gray-400 border-dashed border-2 border-gray-600 rounded-lg">
          <a
            href="https://www.instagram.com/etha040321/"
            className="flex gap-x-4 p-3 px-12 bg-purple-700 hover:bg-purple-800 rounded-full border-white  border-2 text-white font-semibold"
          >
            See More <MoveRight />
          </a>
        </div>
